        ...
        body: BlocBuilder<TopicSettingsCubit, TopicSettingsState>(
          builder: (context, state) {
            return Padding(
              ...
              child: Column(
                children: [
                  Card(child: ListTile(title: const Text('Название'), subtitle: Text(state.topic.name))),
                  const SizedBox(height: 16),
                  Card(child: ListTile(title: const Text('Всего слов'), subtitle: Text('${state.wordCount}'))),
                  const SizedBox(height: 16),
                  ElevatedButton(
